const projects = [
  {
    ...
    link: 'https://www.goldmaneagle.com/',
    category: 'website'
  },
  {
    image: 'https://res.cloudinary.com/adriantoddross/image/upload/v1549920576/myautocarrier.png',
    title: 'MyAutoCarrier',
    description: 'MyAutoCarrier is a car shipping company based out of Atlanta, GA. Unfortunately, I didn\'t get to see this project through. A miscommunication about the initial features and functionality of the site led to an unbelievable case of scope creep and I had to cease work on the site. Someday, I\'ll make a blog post about my mistakes throughout this process.',
    stack: 'Squarespace (content management system), CSS',
    link: 'https://www.myautocarrier.com/',
    category: 'website'
  },
  {
    image: 'https://res.cloudinary.com/adriantoddross/image/upload/v1528837857/safeR_Browser_Window.png',
    title: 'SafeR',
  ...
  },
  {
    ...
    description: 'I created a simple budgeting app that lets users create list of bills and project their net income with PostgresQL, Redux Forms and DBeaver.',
